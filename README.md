...
- 🧭 **Accurate Qibla Compass**: Device Orientation API integration with a **±10° Cone of Accuracy** and fallback degree mode for desktop/devices without compass sensors.
...
- 🎨 **Modern Minimalist UI**: Clean SVG icon system (no emojis/slop), dark/light/system theme switcher, and Emerald + Amber color palette.
...
git clone https://github.com/YOUR_USERNAME/WebJadwalSholat.git
cd WebJadwalSholat
...
git init
git add .
git commit -m "feat: initial release of Web Jadwal Sholat & Arah Kiblat"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/WebJadwalSholat.git
...
You can deploy this project to Vercel for free in under 1 minute:
