...
export function IconKaaba({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4 4h16v16H4V4zm2 2v12h12V6H6zm1 2h10v2H7V8z" />
    </svg>
  )
}

export function IconMosqueLogo({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 3v3" />
      <path d="M12 6c-2.5 0-4.5 1.8-4.5 4v9h9v-9c0-2.2-2-4-4.5-4z" />
      <path d="M4 11v8h3.5" />
      <path d="M20 11v8h-3.5" />
      <path d="M4 11c0-1.2.8-2 2-2s2 .8 2 2" />
      <path d="M16 11c0-1.2.8-2 2-2s2 .8 2 2" />
      <path d="M10.5 19v-4a1.5 1.5 0 0 1 3 0v4" />
    </svg>
  )
}
